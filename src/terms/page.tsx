...
const items = [
  ...
  },
  {
    ...
    text: "يُمنع منعًا باتًا إرسال أسعار المنتجات أو العروض لأي طرف ثالث. أي مخالفة قد تؤدي إلى إيقاف الحساب وتجميد الأموال، ويحتفظ فريق AdamZone بالحق في اتخاذ الإجراءات اللازمة.",
    emphasize: true,
  },
  {
    icon: UserCheck,
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground sm:text-base">
                يرجى قراءة البنود التالية بعناية لضمان تجربة استخدام آمنة وواضحة داخل AdamZone.
              </p>
            </div>
          </motion.div>
        </div>
