...
const faqs: FAQItem[] = [
  {
    ...
    icon: Ticket,
    tag: "الخدمات",
    q: "ما هي الخدمات الرقمية التي تقدمها UBBA؟",
    a: "في UBBA، نقدم مجموعة متنوعة من الخدمات الرقمية مثل اشتراكات التطبيقات، شحن الألعاب، بيع برامج مرخصة، وبيع بطاقات هدايا للمستخدمين. يمكنك العثور على خدماتك المفضلة بكل سهولة.",
  },
  {
    id: 2,
    icon: CreditCard,
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="max-w-3xl text-sm text-muted-foreground sm:text-base leading-7">
                هنا ستجد إجابات لأكثر الأسئلة تكرارًا حول خدمات UBBA وطريقة
