...
export default function ChangeDebitStatusForm({
  orderId,
  status,
  query,
}: {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent dir={i18n.language == "en" ? "ltr" : "rtl"}>
        <DialogHeader>
          <DialogTitle className="text-start">{t("change_order_status")}</DialogTitle>
          <DialogDescription className="text-start">{t("choose_status")}:</DialogDescription>
        </DialogHeader>
        <RadioGroup
