  ...
  return (
    <div dir={i18n.language === "ar" ? "rtl" : "ltr"}>
      <section className="space-y-4 pb-32">
        <div className="rounded-2xl border border-rose-500/30 bg-gradient-to-br from-rose-100 to-card p-6 dark:from-rose-950/40 dark:to-card">
          <p className="text-sm font-semibold text-rose-600 dark:text-rose-300/90">
            {t("debit_balance") || "رصيد الدين"}
          </p>
          <p className="mt-2 font-orbitron text-4xl font-black tabular-nums text-foreground">
            {coins.toFixed(2)}{" "}
